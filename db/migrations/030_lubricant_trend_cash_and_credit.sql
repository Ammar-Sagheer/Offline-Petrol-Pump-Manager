-- ---------------------------------------------------------------------------
-- 030 - the lubricant trend carries its cash/credit split
--
...
-- nothing.
--
-- Ported from the reference app's 043_lubricant_trend_cash_and_credit.sql.
-- Only the restated grants differ: app_user rather than `authenticated`, and
-- no anon role to revoke from.
-- ---------------------------------------------------------------------------
...
revoke execute on function public.get_lubricant_trend(date, date) from public;
grant  execute on function public.get_lubricant_trend(date, date) to app_user;
