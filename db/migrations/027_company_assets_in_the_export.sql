-- =============================================================================
-- 027_company_assets_in_the_export.sql
--
...
-- subtracted by hand.
--
-- Ported from the reference app's 040_company_assets_in_the_export.sql,
-- verbatim: get_month_export reads company_assets and nothing else changes.
-- The table and its RLS arrived here in 025, so the two new result sets have
-- something to read the moment this runs.
-- =============================================================================
