...
--
-- Ported from the reference app's 028_loose_oil.sql. Plain Postgres throughout
-- - the only edit is the grant at the bottom targeting app_user rather than
-- Supabase's `authenticated` (see 004).
--
...
-- after a month. Done now because lubricant_sales is empty on this build too -
-- 013 created it - so this is a column change rather than a data migration.
-- =============================================================================
...
-- unchanged. Its definition is copied verbatim from 013 on purpose:
...
-- 013 verbatim, `when` clause included: without it, flipping
