-- =============================================================================
-- 019_loose_oil_in_the_export.sql
--
-- Ported from the reference app's 030_loose_oil_in_the_export.sql. Plain
-- Postgres; the only edit is the grant at the bottom targeting app_user
-- (see 004).
--
-- The workbook learns about the drum.
--
-- Three additions to get_month_export, and nothing else - the export RPC is a
-- copy of the monthly report shaped for the spreadsheet, and 017
