-- =============================================================================
-- 022_purge_a_mistyped_customer.sql
--
-- Ported from the reference app's 033_purge_a_mistyped_customer.sql. Plain
-- Postgres; the only edits are the grants at the bottom targeting app_user.
--
...
--
-- The UPDATE half is copied verbatim from 013 - restated in full
...
revoke execute on function public.purge_customer(uuid, text) from public;
grant  execute on function public.purge_customer(uuid, text) to app_user;
