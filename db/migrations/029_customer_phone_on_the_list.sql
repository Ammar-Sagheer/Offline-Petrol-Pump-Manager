-- ---------------------------------------------------------------------------
-- 029 - the phone number reaches the Customers list
--
...
--
-- Ported from the reference app's 042_customer_phone_on_the_list.sql. Only the
-- restated grants differ: app_user rather than `authenticated`, and no anon
-- role to revoke from.
-- ---------------------------------------------------------------------------
