...
--
-- Ported verbatim from the reference app's 027_no_backfill_without_room.sql.
-- It replaces 015's function body outright; the two are kept as separate files
-- so the reasoning behind each stays where it was written.
--
-- Migration 015 refused readings that OVERLAP the next one. This closes the
...
-- 015 would still accept is the opening itself - a nought-litre day.
--
