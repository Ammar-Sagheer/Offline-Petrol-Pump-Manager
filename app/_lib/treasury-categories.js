 ...
 * (migration 032). The two lists must stay in step: adding one here without
 ...
 * but it is the word an owner already writes against most cash-in lines on
 * paper, and a page that renames it teaches a second vocabulary for something
 * already named. Same reasoning for "Cash of shift closing", which is longer
 * than it needs to be and is what gets written.
 *
